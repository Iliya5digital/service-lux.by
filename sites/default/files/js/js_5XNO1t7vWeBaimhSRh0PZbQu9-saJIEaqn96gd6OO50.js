/* Source and licensing information for the line(s) below can be found at https://service-lux.by/core/modules/ckeditor5/js/ckeditor5.dialog.fix.js. */
...
/* Source and licensing information for the above line(s) can be found at https://service-lux.by/core/modules/ckeditor5/js/ckeditor5.dialog.fix.js. */;
/* Source and licensing information for the line(s) below can be found at https://service-lux.by/core/misc/dialog/dialog.ajax.js. */
...
/* Source and licensing information for the above line(s) can be found at https://service-lux.by/core/misc/dialog/dialog.ajax.js. */;
/* Source and licensing information for the line(s) below can be found at https://service-lux.by/themes/custom/allsbpr5/assets/js/allsbpr5.script.js. */
/******/ (() => { // webpackBootstrap
...
/******/ 		var installedChunks = {
/******/ 			"/js/allsbpr5.script": 0,
/******/ 			"css/allsbpr5.style": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["css/allsbpr5.style"], () => (__webpack_require__("./src/js/allsbpr5.script.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/allsbpr5.style"], () => (__webpack_require__("./src/scss/allsbpr5.style.scss")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
/* Source and licensing information for the above line(s) can be found at https://service-lux.by/themes/custom/allsbpr5/assets/js/allsbpr5.script.js. */;
/* Source and licensing information for the line(s) below can be found at https://service-lux.by/themes/custom/allsbpr5/src/js/collapsmn.js. */
(function($){$(function(){$('.othermenu').on('click',function(e){$('.other__inner').slideUp('slow');if($(this).parent().find('.other__inner').is(':visible')){$(this).parent().find('.other__inner').slideUp('slow')}else $(this).parent().find('.other__inner').slideToggle('slow');e.preventDefault();e.stopPropagation()});$('.close-modal').on('click',function(e){$('.other__inner').slideUp('slow');if($(this).parent().find('.other__inner').is(':hidden')){$(this).parent().find('.other__inner').slideUp('slow')}else $(this).parent().find('.other__inner').slideToggle('slow');e.preventDefault();e.stopPropagation()})})})(jQuery)
/* Source and licensing information for the above line(s) can be found at https://service-lux.by/themes/custom/allsbpr5/src/js/collapsmn.js. */;
...
/* Source and licensing information for the line(s) below can be found at https://service-lux.by/themes/custom/allsbpr5/src/js/landing.scroll.js. */
(function($){jQuery(window).scroll(function(){var $sections=$('section');$sections.each(function(i,el){var top=$(el).offset().top-40,bottom=top+$(el).height(),scroll=$(window).scrollTop(),id=$(el).attr('id');if(scroll>top&&scroll<bottom){$('a.active').removeClass('active');$('a[href="#'+id+'"]').addClass('active')}})})})(jQuery);(function($){$('a[href*="#"]').on('click',function(){$('html, body').animate({scrollTop:$($.attr(this,'href')).offset().top-200},400);return false})})(jQuery)
/* Source and licensing information for the above line(s) can be found at https://service-lux.by/themes/custom/allsbpr5/src/js/landing.scroll.js. */;
